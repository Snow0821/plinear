...
exp_path = "ImageNet_32_ConvMix"
data_path = "benjamin-paine/imagenet-1k-32x32"
...
from plinear.models import ConvMixer
...
for epoch in range(num_epochs):
    ...
    model.push_to_hub(f'snowian/imageNet_32_btConvMix_{dim}_{depth}_{epoch + 1}')
